...
stimmen die gemessenen Werte nicht mit den Literaturwerten überein, selbst unter Berücksichtigung der Abweichungen durch Messungenauigkeiten $\Delta n$. Genau
wie bei Prisma 1 sind
die gemessenen Brechungsindizes zu hoch. Es kann also von einem der in Teil 1 erläuterten systemischen Fehler ausgegangen werden.
\\
...
\end{table}
\noindent
Die Literaturwerte hier aus [krauter]: 1,59 Für Blaues Licht sowie 1,54 Für Rotes Licht. Die Abweichung hier kommt wahrscheinlich von dem gleichen Fehler wie in den Messungen für die anderen Materialien.
Auch hier sind die gemessenen Brechungsindizes größer als die der Literaturwerte. Für eine Fehleranlyse sie Teil 1. 
